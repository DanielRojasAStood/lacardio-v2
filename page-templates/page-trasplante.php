                    ...
                    <div class="row">
                        <div class="col-12 col-md-3 col-sm-6" style="border-right: 1px solid #05C3DE;">
                            <a href="<?= $link_trasplante_1 ?>" style="text-decoration: none;">
                                <p style="color: #002D72;font-weight: bold;font-size: 17px;line-height: 26px;text-align: center;margin: 0;font-family: 'Prompt';">
                                <?= $trasplante_1 ?>
                                </p>
                            </a>
                        </div>
                ...
                <div class="container">
                    <div class="row grid-container">
                        ...
                        <h2 class="titulos-internos" style="text-align: center;">Tipos de donantes </h2>
                            ...
                            <div  id="donante-vivo">
                            <h2 class="titulos-internos" >¿Qué significa ser un donante vivo de hígado? </h2>
                                    ...
                                    <h2 class="titulos-internos" >¿Quién puede ser donante vivo? </h2>
                                        <p>
                                    ...
                                    <h2 class="titulos-internos" >¿Qué significa ser un donante vivo de riñón? </h2>
                                    ...
                                    <h2 class="titulos-internos" > ¿Quien puede ser donante vivo de riñón?</h2>
