            ...
            <div class="row">
                <div class="col-12 col-md-3" style="position:relative;">
                    <div class="contenedor-tarifas-chequeo" style="bottom: 0px;width: 90%;">
                        <h2 style="color: #002D72;font-weight: 600;font-size: 24px;line-height: 30px;text-align: right;">Chequeo Mujer</h2>
                ...
                <div class="col-12 col-md-3" style="position:relative;">
                    <div class="contenedor-tarifas-chequeo" style="bottom: 0px;">
                        <h2 style="color: #002D72;font-weight: 600;font-size: 24px;line-height: 30px;">Chequeo Hombre</h2>
