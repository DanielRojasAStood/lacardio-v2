        ...
        <div class="seccionRevTextoImagen__flex <?php echo $estilo_targeta; ?>">
            <div class="seccionRevTextoImagen__col">
                <div class="seccionRevTextoImagen__info">
                    ...
                    <?php if($titulo) : ?>
                    <h2 class="heading--48 color--002D72">Innovación y Precisión Cardiaca</h2>
                    <?php endif; ?>

                    <?php if($descripcion) : ?>
                    <p class="heading--18 color--263956">
                        El programa de excelencia tiene como objetivo el manejo integral de los pacientes con diagnóstico de enfermedad coronaria que son sometidos a cirugia de revascularizacion miocardica (Injerto de derivación de arterias coronarias), con la visión de ser referentes en latinoamerica por ofrecer el mejor y más eficiente cuidado y manejo quirurgico siempre entregando la mejor medicina con corazón.
                    </p>
                    <?php endif; ?>
                </div>
            </div>
