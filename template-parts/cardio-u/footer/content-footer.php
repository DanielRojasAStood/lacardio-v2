...
$grupo_copyright     = ($headerFooterCardioU) ? get_field('grupo_copyright', $headerFooterCardioU) : null;
                ...
                <nav class="seccionCardioUFooter__menu">
                    <ul>
                        ...
                        ?>
                            <li>
                                <h3>
                                    <a class="heading--14" href="<?php echo $url ?>" target="<?php echo $target ?>" title="<?php echo $titulo ?>">
                                        <?php echo $titulo ?>
                                    </a>
                                </h3>
                            </li>
