        ...
        <div class="servicios__menumain">
            <ul>
                <?php foreach($menuPpal as $cadaItem): ?>
                    <li>
                        <a href="/servicios/<?= $cadaItem["servicio"]["slug"] ?>/" <?php if($grupo_actual["slug"] == $cadaItem["slug"]): ?>class="activo"<?php endif ?>><span class="icono"><img src="/wp-content/uploads/2023/05/servicios_icon.svg" alt="<?= $cadaItem["nombre"] ?>"></span><span class="texto"><?= $cadaItem["nombre"] ?></span></a>
                    </li>
                <?php endforeach ?>
            </ul>
        </div>
            ...
            <div class="servicios__menusec">
                <ul>
                    <?php foreach($menuSec as $cadaItem): ?>
                        <li>
                            <a href="/servicios/<?= $cadaItem["slug"] ?>/" <?php if($seccion_actual == $cadaItem["slug"]): ?>class="activo"<?php endif ?>><?= $cadaItem["nombre"] ?></a>
                        </li>
                    <?php endforeach ?>
                </ul>
            </div>
            <div class="servicios__content">
                <div class="servicios__content__content">
                    ...
                    <?php if(is_array($doctores)): ?>
                        <h2>Especialistas y equipo humano</h2>
                    <?php endif ?>
                </div>
                <div class="servicios__content__doctores">
                    <div class="slider_doctores">
                                ...
                                <div class="accordion" id="labs-clinicos-acordion">
                                    <?php while ($custom_query->have_posts()) : $custom_query->the_post(); ?>
                                        <div class="accordion-item" data-title="<?php echo get_the_title(); ?>">
                                            <h2 class="accordion-header mw-100" id="lab-clinico-item-<?php the_ID(); ?>-btn">
                                            ...
                                            <div id="lab-clinico-item-<?php the_ID(); ?>" class="accordion-collapse collapse" aria-labelledby="lab-clinico-item-<?php the_ID(); ?>-btn" data-bs-parent="#labs-clinicos-acordion">
                                                <div class="accordion-body">
                                                    ...
                                                    <h4>Condiciones del paciente y/o datos anexos</h4>
                                                    <?php the_content(); ?>
                                                    <h4>Día de montaje</h4>
...
/* Filtrar por letra */
document.getElementById('type_letter').addEventListener('change', function () {
