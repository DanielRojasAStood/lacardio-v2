...
<main>
    <div class="paginaInternaBlog">
        ...
        <div class="seccionInternaBlogInfo__caja-gris">
            <div class="container--large">
                <h2 class="heading--48 seccionInternaBlogMasInfo__h2">Más de <?php echo $autor_home ?></h2>
                <div class="seccionInternaBlogMasInfo">
                    <?php 
                        $current_author_home = get_field('autor_home', get_the_ID());
                        $args = array(
                        ...
                        ?>
                            ...
                            echo '<p>No se encontraron posts con el mismo autor_home.</p>';
                        endif;
                    ?>
                </div>
            </div>
